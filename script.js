...
const folgasPorTurmaEMes = {
    ...
    '2026-1': { 'A': [2, 3, 10, 14, 18, 19, 26, 27], 'B': [4, 5, 12, 13, 20, 21, 25, 29], 'C': [6, 7, 11, 15, 22, 23, 30, 31], 'D': [1, 8, 9, 16, 17, 24, 28] },
    '2026-2': { 'A': [1, 2], 'B': [3, 4], 'C': [5, 6], 'D': [7, 8] }, 
    '2026-3': { 'A': [1, 2], 'B': [3, 4], 'C': [5, 6], 'D': [7, 8] },
